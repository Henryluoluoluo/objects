...
<%@ page import = "com.rain.bean.TypeBean,com.rain.dao.AdminDao,com.rain.dao.TypeDao,com.rain.bean.TypeBean,com.rain.dao.ObjectDao,com.rain.bean.AdminBean" %>
...
<head>
    ...
    <script type="text/javascript" src = "static/js/AdminAddObjectType.js"></script>
    <script type="text/javascript" src = "static/js/AdminUpdateObjectType.js"></script>
...
<body class="bootstrap-admin-with-small-navbar" style="background: url(./static/images/background1.jpg);background-size:100% 100%;background-attachment: fixed;transform: scale(1.0);">
                    ...
                    <div class="collapse navbar-collapse main-navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <span><% out.write(admin.getName());%></span>  
                                <i class="caret"></i></a>
    ...
    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                            <%
                             	ArrayList<TypeBean> objectdata = new ArrayList<TypeBean>();
                             	objectdata = (ArrayList<TypeBean>)request.getAttribute("data");
                           		if(objectdata==null){
                        	   		TypeDao objectdao = new TypeDao();
                        	   		objectdata = (ArrayList<TypeBean>)objectdao.get_ListInfo();
                           		}	
  								for(TypeBean bean : objectdata){
 							%>                 
							<tbody>
	                       		<td><%= bean.getName() %></td>	                               
								...
								<button type="button" class="btn btn-danger btn-xs" onclick="deleteobject(<%= bean.getTid() %>)">删除</button>
								</td>                                            
                          	</tbody>
                       		<%} %> 
                        </table>
    	...
    	function deleteobject(tid) {
    		con=confirm("是否删除?"); 
    		if(con==true){
    		location.href = "/objects/deleteTypeServlet?tid="+tid;
    		}
    	}
    	</script>
        <!-- 修改模态框（Modal） -->
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">									
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<input type="text" class="form-control" id="updatename" name="name"  placeholder="请输入物品分类名称">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" onclick="updateObjectType()" >修改</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal -->
			</div>	
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">分类名称</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addObjectName" required="required" name="name"  placeholder="请输入物品分类名称">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
							<button type="button" class="btn btn-primary" onclick="addObjectType()" >添加</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal -->
			</div>
