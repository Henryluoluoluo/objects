...
<%@ page import = "com.rain.bean.AdminBean,com.rain.bean.HistoryBean,com.rain.dao.ObjectDao,com.rain.dao.AdminDao" %>
	    ...
	    <div class="row">
	        ...
	        <div class="col-md-10">
	            	...
	            	<div class="col-lg-12">
	                	<div class="panel panel-default bootstrap-admin-no-table-panel">
	                    	<div class="panel-heading">
	                        	<div class="text-muted bootstrap-admin-box-title">当前借出信息</div>
	                        </div>  
	                    </div>
	                </div>
	            </div>
	                	...
	                	<table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
	                        ...
	                        <%
	                            ...
	                            if(objectdata==null){
	                        	    ...
	                        	    objectdata = (ArrayList<HistoryBean>)objectdao.get_HistoryListInfo(1,aid);
	                           	}
	                        ...
	                        <tbody>
		                        ...
		                        <td><button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haiobject(<%= bean.getHid() %>,<%= bean.getOid() %>)">归还</button></td>                                               
	                        </tbody>
	                        <%} %> 
	                    </table>
	                </div>
	    		...
	    		function haiobject(hid,oid) {
	    			con=confirm("是否归还?"); 
	    			if(con==true){
	    				location.href = "/objects/borrowServlet?tip=2&show=1&hid="+hid+"&oid="+oid;
	    			}
	    		}
	    		</script>
	        </div>
					...
					<div class="modal-body">												
						<!---------------------表单-------------------->
			 			<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">借出编号</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="borrowId"  readonly="readonly">												
							</div>
						</div>										
						<div class="form-group">	
							<label for="firstname" class="col-sm-3 control-label">借出书籍ISBN号</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="ISBN"  readonly="readonly">
							</div>
						</div>											
						<div class="form-group">	
							<label for="firstname" class="col-sm-3 control-label">借出书籍名称</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="objectName"  readonly="readonly">												
							</div>
						</div>
						<div class="form-group">	
							<label for="firstname" class="col-sm-3 control-label">借出书籍类型</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" id="objectType"  readonly="readonly">											
								</div>
						</div>									
						<div class="form-group">	
							<label for="firstname" class="col-sm-3 control-label">用户证件号</label>
							<div class="col-sm-7">
